$(document).ready(function () {
    ...
    $("#zywd").click(function () {
        ...
        /*总金额*/
        var zje = 0;
        zje = Number($("#index_xj").val()) + Number($("#index_wx").val()) + Number($("#index_zfb").val()) + Number($("#index_yhk").val()) + Number($("#index_mtxsy").val()) + Number($("#index_bdxsy").val()) + Number($("#index_elmxsy").val())
        ...
        var line1 =
            ...
            "<li>" + "百度外卖线上支付：" + $("#index_bdxsd").val() +"单" + $("#index_bdxsy").val() +"元</li>" +
            "<li>" + "饿了么外卖线上支付：" + $("#index_elmxsd").val() +"单" + $("#index_elmxsy").val() +"元</li>" +
            "<li>" + "堂吃：" + tc + "</li>" +
            "<li>" + "堂吃占比：" + tczb + "</li>" +
            "<li>" + "外带：" + wd + "</li>" +
            "<li>" + "外带占比：" + wdzb + "</li>" +
